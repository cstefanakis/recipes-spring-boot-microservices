...
import com.recipe.auth.services.JwtService;
...
class UserControllerTest {
    ...
    void updatedUser() throws Exception {
        //Arrange
        Integer userId = this.user.getId();
        UpdateUserResponseDto updateUserRequestDto =
        ...
        //Mock
        when(userService.getUpdatedUserByUserId(eq(userId), any(UpdateUserRequestDto.class)))
